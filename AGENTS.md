# AGENTS.md — postgres-dba-agent

> PostgreSQL monitoring with LLM-generated tuning advice to Slack
...
- **Stack**: Python, PostgreSQL, Prometheus, Grafana, Docker
- **Interface registry**: none (database and Slack only)
